...
/* ============================================================
   ...
   ============================================================ */
const MCOS = ["Sunflower Health Plan", "UnitedHealthcare Community", "Aetna Better Health of Kansas", "Blue Cross Blue Shield KS"];
          ...
          <div style={{ borderTop: `1px solid ${T.border}`, paddingTop: 14 }}>
            ...
            {c.stage === "recertified" && (
              <div>
                ...
                {c.outcome === "denied_ineligible" && <div style={{ fontSize: 12.5, color: T.textMid, background: T.surface2, border: `1px solid ${T.border}`, borderRadius: 10, padding: "12px", lineHeight: 1.5 }}><div style={{ fontWeight: 800, color: T.text, display: "flex", alignItems: "center", gap: 7 }}><X size={16} /> Closed — Ineligible</div>Not a procedural failure. Refer to Kansas Department of Health and Environment for Marketplace / Family Planning options.</div>}
                {c.outcome === "pending" && (
                  <div>
