...
// H.R. 1 / Kansas work-requirement constants
const WR_STATUS = {
    ...
    <div style={{ width: 234, flex: "0 0 234px", background: T.ink, color: T.textInv, display: "flex", flexDirection: "column", position: "sticky", top: 0, height: "100vh" }}>
      <div style={{ padding: "20px 18px 16px", borderBottom: `1px solid ${T.line}` }}>
        <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
          ...
          <div>
            <div style={{ fontSize: 14.5, fontWeight: 800, letterSpacing: .2 }}>CoverageGuard <span style={{ color: T.teal }}>IQ</span> Kansas</div>
            <div style={{ fontSize: 10, color: T.textInvLo, letterSpacing: .4, marginTop: 1 }}>CERTCORE</div>
          </div>
        </div>
      </div>
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",gap:20}}>
      ...
      <div style={{background:T.ink,borderRadius:14,padding:"14px 18px",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
        <div>
          <div style={{fontSize:11,fontWeight:800,color:T.teal,textTransform:"uppercase",letterSpacing:.5,marginBottom:4}}>H.R.1 — Big Beautiful Bill</div>
    ...
    <div>
      ...
      {dualEligCount > 0 && (
        <div style={{marginBottom:14,padding:"10px 14px",background:T.teal+"10",border:`1px solid ${T.teal+"30"}`,borderRadius:10,fontSize:12.5,color:T.textMid,display:"flex",alignItems:"center",gap:8}}>
          ...
          <span><strong style={{color:T.teal,fontWeight:700}}>{dualEligCount} dual eligible</strong> patient{dualEligCount>1?"s":""} are auto-exempt from work requirement — Medicare + Medicaid both active · no clinician attestation required · categorically exempt by KanCare policy</span>
        </div>
      )}
      ...
      {(()=>{
        ...
        return (
          <div style={{background:T.surface,border:`1px solid ${T.border}`,borderRadius:13,padding:"16px 18px"}}>
            ...
            <div style={{fontSize:11.5,color:T.textMid,marginBottom:16}}>Actual outcomes from {CFG.brand} · eClinicalWorks + Kansas Department of Health and Environment · {effectiveStart} to {effectiveEnd} · {fmt(fin.processed)} renewals processed</div>
          ...
          },
          {
            ...
            generate: () => {
              ...
              const lines = [
                ...
                `Submitted → State determination:    15–45 days (KanCare)`,
  ...
  return (
    <div style={{position:"absolute",inset:0,background:T.surface,zIndex:10,display:"flex",flexDirection:"column",animation:"cgSlide .18s ease"}}>
      ...
      <div style={{flex:1,overflowY:"auto",padding:"14px 16px",display:"flex",flexDirection:"column",gap:12}}>
        ...
        {step===2 && (<>
          ...
          {consentPath==="self"&&(
            <div style={{padding:"12px 14px",background:T.surface2,border:`1px solid ${T.border}`,borderRadius:10}}>
              ...
              <div style={{fontSize:12.5,color:T.textMid,lineHeight:1.6,marginBottom:8}}>Patient will self-submit at <b>kancare.ks.gov</b>. Follow-up set 14 days before renewal deadline.</div>
        ...
        {step===4 && (<>
          <div style={{fontSize:12.5,color:T.textMid,lineHeight:1.5}}>Auth-rep packet assembled. Review before sending to Kansas Department of Health and Environment.</div>
          ...
          <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
            ...
            <button onClick={onDone} style={{...primaryBtn,padding:"8px 16px",fontSize:12.5,background:T.teal,flex:1,justifyContent:"center"}}>
              <Send size={14}/> Submit to Kansas Department of Health and Environment
            </button>
          </div>
                  ...
                  <div onClick={e=>e.stopPropagation()} style={{background:T.surface,borderRadius:16,padding:22,width:"min(440px,92vw)",boxShadow:"-4px 4px 32px rgba(0,0,0,.18)"}}>
                    ...
                    {consentPath==="self" && (
                      <div style={{padding:"13px 14px",background:T.surface2,border:`1px solid ${T.border}`,borderRadius:10,marginBottom:14}}>
                        ...
                        <div style={{fontSize:12.5,color:T.textMid,lineHeight:1.6,marginBottom:10}}>Patient will self-submit at <b>kancare.ks.gov</b>. A follow-up reminder will be set 14 days before their renewal deadline.</div>
              ...
              <div onClick={e=>e.stopPropagation()} style={{background:T.surface,borderRadius:16,padding:22,width:"min(560px,96vw)",maxHeight:"90vh",overflowY:"auto",boxShadow:"-4px 4px 40px rgba(0,0,0,.22)"}}>
                ...
                <div style={{background:T.red+"0C",border:`1px solid ${T.red}33`,borderRadius:10,padding:"10px 13px",marginBottom:14,display:"flex",gap:10,alignItems:"flex-start"}}>
                  ...
                  <div>
                    ...
                    <div style={{fontSize:11.5,color:T.textMid,lineHeight:1.5}}>KDOL wage records: no employer match for {p.first} {p.last} (past 4 quarters). SNAP/TANF: not enrolled. SSA: no benefit record. Member must self-document activity.</div>
                  </div>
                </div>
...
/* ============================================================
   ...
   ============================================================ */
const MCOS = ["Priority Partners", "Sunflower Health Plan", "MedStar Family Choice", "UnitedHealthcare Community", "Wellpoint (Amerigroup)", "Aetna Better Health", "Jai Medical Systems", "CareFirst Community"];
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "minmax(0, 1.6fr) minmax(0, 1fr)", gap: 16 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <Card title="Complements Kansas Department of Health and Environment" sub="Never duplicates or impersonates the State">
            <div style={{ fontSize: 12.5, color: T.textMid, lineHeight: 1.6 }}>
              <div style={{ display: "flex", gap: 8, marginBottom: 7 }}><CheckCircle2 size={14} color={T.green} style={{ flex: "0 0 auto", marginTop: 1 }} /> Outreach points members to the official check-in at <b>{MHC.checkin}</b> and their Kansas Department of Health and Environment notice.</div>
...
function IntakeView({ reduced, onComplete = () => {}, setView = () => {} }) {
  ...
  function advance(text) {
    ...
    if (state === "CONSENT_CHECK") {
      ...
      return setTimeout(() => agentSay("Kansas's new rules let you name the health center as your authorized representative, so we can submit your paperwork and receive the State's notices for you. Want the health center to represent you? Reply 1 = yes, the health center can help; 2 = no, I'll do it myself.", "auth_rep", C("AUTH_REP", { state: "AUTH_REP", preferred_language: lang })), reduced ? 0 : 200);
    }
    if (state === "AUTH_REP") {
...
const REQUIRED_DOCS = [
  ...
  { key: "residency", name: "Proof of Kansas residency" },
...
const AR_SCOPE = [
  ...
  { key: "comm", label: "Communicate with Kansas Department of Health and Environment / LDSS (Local Department of Social Services)" },
...
function WREngagementQueue({ panel, addPending, pushAudit }) {
  ...
  const PATHWAYS = [
    ...
    { key:"training",    label:"Job training / SNAP E&T", sub:"Kansas SNAP Employment & Training program",          resource:"https://dcf.ks.gov" },
    ...
    { key:"caregiving",  label:"Caregiving",              sub:"Caring for a dependent child or disabled adult",       resource:"https://dcf.ks.gov" },
  ...
  const SMS_TEMPLATES = {
    ...
    training:    "Hi [name], your Medicaid has an 80-hr/month activity requirement. Job training and education programs qualify. Kansas SNAP E&T can help — reply 1 for a free referral.",
    ...
    jobcenter:   "Hi [name], Kansas's American Job Centers offer free help finding work — and connecting to jobs counts toward your Medicaid requirement. Reply 1 to get connected.",
                ...
                <div onClick={e=>e.stopPropagation()} style={{background:T.surface,borderRadius:16,padding:22,width:"min(480px,94vw)",boxShadow:"-4px 4px 40px rgba(0,0,0,.22)"}}>
                  ...
                  {outc==="denied_ineligible"&&(<>
                    ...
                    <div style={{marginBottom:10}}>
                      ...
                      <textarea value={detail} onChange={e=>setDetail(e.target.value)} placeholder="Income over limit, no longer Kansas resident, citizenship status, etc."
                    ...
                    <div style={{background:T.red+"0C",border:`1px solid ${T.red}33`,borderRadius:9,padding:"9px 12px",fontSize:12,color:T.textMid,marginBottom:14}}>
                      ...
                      Patient has 90 days to appeal from the notice date. Refer to Kansas Department of Health and Environment for Marketplace / Family Planning alternatives.
                    </div>
                    <div style={{display:"flex",gap:8,justifyContent:"flex-end"}}>
                      <button onClick={()=>setShowDetModal(false)} style={{...ghostBtn,padding:"8px 13px"}}>Cancel</button>
              ...
              <div>
                ...
                {c.outcome === "denied_ineligible" && (
                  <div style={{fontSize:12.5,color:T.textMid,background:T.surface2,border:`1px solid ${T.border}`,borderRadius:10,padding:"12px",lineHeight:1.5}}>
                    ...
                    Appeal rights attach — 90 days from notice date. Refer to Kansas Department of Health and Environment for Marketplace / Family Planning options.
                  </div>
                )}
              </div>
            )}
...
const DOC_LIB = {
  id: "Photo ID",
  residency: "Proof of Kansas residency",
...
function RecertPerformance({ fin, assumptions = FIN_DEFAULT, onAssumptions }) {
  ...
  return (
    <Card title={`Recertification performance — ${CFG.brand} · season to date`} sub={`Actual outcomes · eClinicalWorks + Kansas Department of Health and Environment · Jun 30 – Aug 22, 2026 · ${fmt(fin.processed)} renewals processed`}>
      <div style={{ display: "grid", gridTemplateColumns: "minmax(0, 1fr) minmax(0, 1.15fr)", gap: 18 }}>
        {/* success + outcome bar */}
        <div>
          <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
...
/* ============================================================
   H.R. 1 / Kansas work-requirement readiness
   ============================================================ */
...
function HR1Readiness({ hr1 }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
      <Card title="H.R. 1 work-requirement readiness" sub="New Kansas Medicaid rules · 80 hrs/mo activity + 6-month renewals · effective Jan 1, 2027">
      ...
      <div style={{ fontSize: 10.5, color: T.textLo, marginTop: 14, borderTop: `1px solid ${T.border}`, paddingTop: 10, lineHeight: 1.5 }}>
        Source: <b>{MHC.citation}</b>. States must notify members by <b>{MHC.notifyDeadline}</b>; the requirement begins <b>{MHC.goLive}</b>. Outreach complements the State — it points members to the official check-in (<b>{MHC.checkin}</b>) and their notice, and never impersonates Kansas. <b>Under active challenge:</b> {MHC.litigation}. The impairment standard is the central dispute, so thresholds ({MHC.workReqHours} hrs/mo or ${MHC.workReqIncome}/mo) and every rule here remain configurable. Two operational details — a documentation requirement from {MHC.attestationSunset} and {MHC.frailtyReverifyMonths}-month frailty re-verification — are <b>{MHC.pendingNote}</b> and should be confirmed with counsel and KDHE before the pilot. Synthetic figures.
      </div>
      </Card>
