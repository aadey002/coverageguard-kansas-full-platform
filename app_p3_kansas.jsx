  ...
  return (
    <>
      <div style={{
        ...
        background: "#2A1A00", padding: "8px 16px",
        position: "sticky", top: 0, zIndex: 100
      }}>
        <span style={{color:"#fff",fontWeight:800,fontSize:13}}>
          CoverageGuard IQ — Kansas
        </span>
        <button onClick={() => setProduct("certcore")}
          style={{background: product==="certcore" ? "#8B6914" : "transparent",
            color:"#fff", border:"1px solid #8B6914", borderRadius:8,
            padding:"5px 14px", fontSize:12, fontWeight:700, cursor:"pointer"}}>
          CertCore
        </button>
        <button onClick={() => setProduct("coverage")}
          style={{background: product==="coverage" ? "#8B6914" : "transparent",
            color:"#fff", border:"1px solid #8B6914", borderRadius:8,
            padding:"5px 14px", fontSize:12, fontWeight:700, cursor:"pointer"}}>
